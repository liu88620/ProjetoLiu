...
# gender,
# gender=gender,
def salvar(firstname, lastname, country, state, city, address, zipcode, phone, email):
    curso = Curso(firstame=firstname, lastname=lastname, country=country, state=state,
                  city=city, address=address, zipcode=zipcode, phone=phone, email=email)
    curso.put()
